...
$GLOBALS['TL_LANG']['CTE']['subcolumns']['1'] = "<img src=\"bundles/subcolumns/assets/example_de.png\" alt=\"Пример набора колонок\" style=\"float:right;\" />Набор колонок позволяет легко добавить колоноки в формат сайта. Они могут быть даже каскадными.";
