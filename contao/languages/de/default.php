...
$GLOBALS['TL_LANG']['CTE']['subcolumns'] = ['Spaltenset','<img src="bundles/contaosubcolumns/assets/example_de.png" alt="Beispiel für Spaltensets" style="float:right;" />Spaltensets ermöglichen es mehrere Spalten in das Layout einzufügen. Diese können dabei auch ineinander verschachtelt sein.'];
